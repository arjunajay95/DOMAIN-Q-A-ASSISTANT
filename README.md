...
**Why validate the CSV on upload?** Failing early is better than failing mid-conversation. If the CSV is missing a required column or is empty, you find out immediately at the upload step, not when you're already three questions in.
